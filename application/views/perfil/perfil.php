...
<?php $this->load->view('menus/menu_superior'); ?>
    ...
    <div class="row-odd color_fondo" id="divprincipal">
        ...
        <div class="col-sm-11 color_fondo">
            ...
            <div>
                <form class="formulario-guardar-perfil" id="formulario" enctype="multipart/form-data">
                    ...
                    <div class="row" style="margin-top: 2%;width: 70%;">
                        ...
                        <div class="col-md-4">
                            ...
                            <input value="<?=$dat[0]['usuario']?>" type="text" name="usuario" autocomplete="off" class="form-control" placeholder="" required pattern="[A-Z,a-z,0-9 ]{1,50}">
                        </div>
                        <div class="col-md-4">
