...
<?php $this->load->view('menus/menu_superior'); ?>
    ...
    <div class="row-odd color_fondo" id="divprincipal">
        ...
        <div class="col-sm-11 color_fondo">
            <h4 class="no-margin text-uppercase semi-bold width100">CLIENTES</h4>
                     ...
                     ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <button class="btneliminar btn btn-danger" value="<?=$dato['id_cliente']?>" ><i class="glyphicon glyphicon-trash"></i> Eliminar</button>
                                <button class="btnmodificar btn btn-primary" value="<?=$dato['id_cliente']?>" ><i class="glyphicon glyphicon-edit"></i> Modificar</button>
                            </td>
                        </tr>
                    <?php
                           }
